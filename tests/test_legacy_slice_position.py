...
from hazenlib.tasks.legacy_slice_position import LegacySlicePosition
from tests import TEST_DATA_DIR


class TestLegacySlicePositionSiemens(unittest.TestCase):
...
class TestLegacySlicePositionGE(TestLegacySlicePositionSiemens):
